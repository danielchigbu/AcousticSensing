//
 ...
 - (void)setupAudioSession
 {
     ...
     XThrowIfError((OSStatus)error.code, "couldn't set session's audio category");
        ...
        // Use measurement mode to disable voice processing (AGC, AEC, etc.)
        ...
        // Prefer mono I/O for stability
        [sessionInstance setPreferredInputNumberOfChannels:1 error:&error];
        XThrowIfError((OSStatus)error.code, "couldn't set preferred input channels");
        [sessionInstance setPreferredOutputNumberOfChannels:1 error:&error];
        XThrowIfError((OSStatus)error.code, "couldn't set preferred output channels");
